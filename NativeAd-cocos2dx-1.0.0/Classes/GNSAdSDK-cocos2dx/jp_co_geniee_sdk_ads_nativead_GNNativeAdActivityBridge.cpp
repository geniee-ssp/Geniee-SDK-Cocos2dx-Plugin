...
using GNSAdSDK::CCGNNativeAdRequest;
using GNSAdSDK::CCGNNativeAd;
...
extern "C" {
    ...
    {
        std::vector<GNSAdSDK::CCGNNativeAd*> nativeAds;
        CCGNNativeAdRequestDelegate* listener = CCGNNativeAdRequest::getDelegate();
        if (listener != NULL) {
            ...
            for (int i = 0; i < cntNativeAd; i++)
            {
                ...
                GNSAdSDK::CCGNNativeAd* nativeAd = GNSAdSDK::CCGNNativeAd::create();
